...
class JPEGOutput extends BaseOutput
{
    ...
    function addOptions(GetOpt $_options)
    {
        $_options->addOptions(array(
            ...
            array(null, "cellColor", GetOpt::REQUIRED_ARGUMENT, "JPEGOutput - Die Farbe der lebenden Zellen. Muss als R,G,B oder #HEX angeben werden. Standard: 255,255,0 (Gelb)"),
            array(null, "bkColor", GetOpt::REQUIRED_ARGUMENT, "JPEGOutput - Die Hintergrundfarbe des Bildes. Muss als R,G,B oder #HEX angeben werden. Standard: 135,135,135 (Grau)\n"),
        ));
    }
}