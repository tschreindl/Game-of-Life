...
class PNGOutput extends BaseOutput
{
    ...
    function addOptions(GetOpt $_options)
    {
        $_options->addOptions(array(
            ...
            array(null, "bkColor", GetOpt::REQUIRED_ARGUMENT, "PNGOutput - Die Hintergrundfarbe des Bildes. Muss als R,G,B oder #HEX oder Standard-Farbe angeben werden. Standard: 128,128,128 (Grau)"),
            array(null, "lineColor", GetOpt::REQUIRED_ARGUMENT, "PNGOutput - Die Farbe des Gitternetz. Muss als R,G,B oder #HEX oder Standard-Farbe angeben werden. Standard: 255,255,255 (Weiß)\n"),
        ));
    }
}